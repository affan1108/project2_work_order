  ...
  return (
    <LinearGradient colors={['#66bb6a','#2e7d32']} useAngle={true} angle={115} angleCenter={{x:0.5, y:0.5}} style={{flex:1}}>
      ...
      <View style={{justifyContent:'space-between', alignItems:'center', marginTop:80, flexDirection:'row', marginHorizontal:20}}>
        <View>
        <Text style={{fontSize:20, color:'white'}}>Hi, Pengguna!,</Text>
      ...
      <View style={{flex:1, backgroundColor:'#fafafa', marginTop:50, borderTopRightRadius:20, borderTopLeftRadius:20}}>
        ...
        <View style={{justifyContent:'space-between',alignItems:'center',flexDirection:'row', paddingHorizontal:20}}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Success')}>
          <LinearGradient colors={['#fff59d','#ffee58']} style={{height:100,width:100,borderRadius:20}} useAngle={true} angle={115} angleCenter={{x:0.5, y:0.5}}>
            <View style={{marginLeft:10,marginTop:10}}>
              <Text style={{color:'black'}}>Assignment</Text>
              <Text style={{color:'black',marginTop:10,fontSize:20}}>10</Text>
            </View>
          </LinearGradient>
          </TouchableOpacity>
        ...
        <View style={{flex:1, backgroundColor:'#f5f5f5',borderTopLeftRadius:20,borderTopRightRadius:20,marginTop:20, padding:30}}>
          <View style={{flexDirection:'row', alignItems:'center', justifyContent:'space-between'}}>
            <Text style={{color:'black', fontSize:20, fontWeight:'400'}}>Recently Assigned</Text>
            <Text style={{color:'black', fontSize:15}}>All Task</Text>
          </View>
          <View style={{marginTop:30, borderBottomWidth:1}}>
            <View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'center'}}>
              <Text style={{color:'black', fontWeight:'500', fontSize:15}}>Perbaikan Printer</Text>
              <View style={{backgroundColor:'yellow', justifyContent:'center', alignItems:'center', borderRadius:10, width:80, height:20}}>
                <Text style={{fontSize:10, color:'black'}}>Assignment</Text>
              </View>
              <Text style={{fontSize:10, color:'black'}}>09/11/22 22:45</Text>
            </View>
            <View style={{marginVertical:5}}>
              <Text>Tinta printer habis, dibutuhkan tinta baru segera</Text>
            </View>
          </View>
        </View>
        {/* <View style={{flex:1, backgroundColor:'#f5f5f5',borderTopLeftRadius:20,borderTopRightRadius:20,marginTop:20}}>
          <View style={{margin:20}}>
            ...
            <ScrollView style={{marginTop:10}}>
              ...
              <TouchableOpacity onPress={() => navigation.navigate('DetailProccess')}>
              ...
              <TouchableOpacity onPress={() => navigation.navigate('DetailCompleted')}>
